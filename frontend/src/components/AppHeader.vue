    ...
    <div class="grid w-full grid-cols-[1fr_auto_1fr] items-center gap-4 px-4 py-3">
      ...
      <div class="hidden items-center justify-self-end gap-2 text-xs md:flex">
        <a
          ...
          class="flex items-center gap-2 rounded-lg border border-white/15 px-3 py-1.5 text-xs font-medium text-slate-200 transition hover:border-indigo-400/50 hover:bg-indigo-500/10 hover:text-white"
          title="GitHub：github.com/zzm921/agent-lab"
        >
        ...
        <button
          ...
          @click="toggleTheme"
        >
          <svg v-if="theme === 'dark'" class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
